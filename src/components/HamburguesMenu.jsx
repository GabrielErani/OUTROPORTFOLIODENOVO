            ...
            >
                ...
                <nav className="mt-10 p-4 w-full">
                    <ul className="text-white text-lg flex flex-col gap-6">
                        <li className="w-full">
                            <a href="#Home" onClick={toggleSidebar} className="flex items-center gap-4 px-4 py-3 bg-gray-900 rounded-lg hover:bg-gray-700 transition-all duration-200 ease-in-out">
                                <HomeIcon className="w-6 h-6" />
                                Home
                            </a>
                        </li>
                        <li className="w-full">
                            <a href="#Skills" onClick={toggleSidebar} className="flex items-center gap-4 px-4 py-3 bg-gray-900 rounded-lg hover:bg-gray-700 transition-all duration-200 ease-in-out">
                                <UserIcon className="w-6 h-6" />
                                Skills
                            </a>
                        </li>
                        <li className="w-full">
                            <a href="#Projects" onClick={toggleSidebar} className="flex items-center gap-4 px-4 py-3 bg-gray-900 rounded-lg hover:bg-gray-700 transition-all duration-200 ease-in-out">
                                <FolderIcon className="w-6 h-6" />
                                Projects
                            </a>
                        </li>
                        <li className="w-full">
                            <a href="#Contact" onClick={toggleSidebar} className="flex items-center gap-4 px-4 py-3 bg-gray-900 rounded-lg hover:bg-gray-700 transition-all duration-200 ease-in-out">
