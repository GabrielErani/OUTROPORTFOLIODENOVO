...
const ProjectSection = () => {
    ...
    return (
    <div className=" min-h-screen h-fit w-full flex items-center  flex-col">
                <h1 className="text-5xl font-bold  bg-gradient-to-br from-zinc-400 to-stone-100 bg-clip-text text-transparent p-4 2xl:text-8xl">Projects</h1>
